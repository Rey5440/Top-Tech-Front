function daysMonthCalendarCustom(totalDays, boolean) {
    ...
    const remaining = daysCurrentMonth.filter(dia => {  // devuelve array con los dias del mes que sean mayores al actual
        if (boolean === true) {
    ...
    const result = { month1: remaining, month2: remainingNext }
